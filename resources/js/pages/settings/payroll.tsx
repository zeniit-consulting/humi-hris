                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    type="number"
                                    min="1"
                                    value={form.data.overtime_hour_divisor}
                                    onChange={(event) =>
                                        form.setData(
                                ...
                                />
                                <p className="text-xs text-muted-foreground">
                                    Gaji per jam = gaji pokok dibagi divisor.
                                    Standar: 173 jam/bulan.
                                </p>
                                <InputError
                                    message={form.errors.overtime_hour_divisor}
                                />
                            </div>
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    step="0.1"
                                    min="1"
                                    value={form.data.overtime_multiplier_hour1}
                                    onChange={(event) =>
                                        form.setData(
                                ...
                                <InputError
                                    message={
                                        form.errors.overtime_multiplier_hour1
                                    }
                                />
                            </div>
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    min="1"
                                    value={
                                        form.data.overtime_multiplier_subsequent
                                    }
                                    onChange={(event) =>
                                        form.setData(
