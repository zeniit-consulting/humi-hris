                                ...
                                <div className="rounded-lg border bg-slate-50/60 p-4">
                                    ...
                                    <div className="grid gap-4 md:grid-cols-3">
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <p className="text-xs text-muted-foreground">Default 22 hari untuk potongan cuti tanpa gaji.</p>
                                        </div>
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <p className="text-xs text-muted-foreground">Mode ambang mengonversi ambang terpenuhi menjadi 8 jam / 1 hari dibayar.</p>
                                        </div>
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <p className="text-xs text-muted-foreground">Contoh: 10 jam dihitung sebagai 8 jam / 1 hari.</p>
                                        </div>
