...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Manpower Request', href: pageUrl },
];
        ...
        <form onSubmit={submit} className="space-y-5">
            <div className="rounded-lg border bg-muted/30 p-4">
                <p className="font-medium">
                    {editing
                        ? 'Perbarui kebutuhan manpower yang sudah tercatat.'
                        : 'Isi kebutuhan manpower baru dari klien atau sub-company.'}
                </p>
                <p className="mt-1 text-sm text-muted-foreground">
                    Lengkapi detail posisi, target headcount, serta status
                    pemenuhan agar tim operasional mudah menindaklanjuti.
                </p>
            </div>
            ...
            <div className="grid gap-4 xl:grid-cols-12">
                <Field
                    label="Sub-company"
                    error={form.errors.sub_company_id}
                    className="xl:col-span-4"
                >
                    <Select
                        value={form.data.sub_company_id}
                        onValueChange={(value) =>
                            form.setData('sub_company_id', value)
                        }
                    >
                        <SelectTrigger>
                ...
                >
                    <Select
                        value={form.data.position_id || '__none'}
                        onValueChange={(value) =>
                            form.setData(
                                'position_id',
                                value === '__none' ? '' : value,
                ...
                <Field
                    label="Headcount Diminta"
                    error={form.errors.requested_headcount}
                    className="md:col-span-1 xl:col-span-3"
                >
                    <Input
                        type="number"
                        min="1"
                        value={form.data.requested_headcount}
                        onChange={(event) =>
                            form.setData(
                                'requested_headcount',
                                event.target.value,
                ...
                <Field
                    label="Headcount Terpenuhi"
                    error={form.errors.fulfilled_headcount}
                    className="md:col-span-1 xl:col-span-3"
                >
                    <Input
                        type="number"
                        min="0"
                        value={form.data.fulfilled_headcount}
                        onChange={(event) =>
                            form.setData(
                                'fulfilled_headcount',
                                event.target.value,
                ...
                >
                    <Input
                        ...
                        onChange={(event) =>
                            form.setData('needed_by', event.target.value)
                        }
                    />
                </Field>
                <Field
            ...
            <div className="flex flex-wrap justify-end gap-2 border-t pt-4">
                ...
                <Button disabled={form.processing}>
                    {editing ? 'Simpan Perubahan' : 'Tambah Request'}
                </Button>
            </div>
        </form>
    );
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-4 p-4">
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Stat
                        label="Kebutuhan Belum Terpenuhi"
                ...
                <Card>
                    ...
                    <CardContent>
                        <form
                            ...
                            className="grid gap-3 md:grid-cols-[220px_180px_auto]"
                        >
                            <Select
                                value={filterState.sub_company_id || '__all'}
                                onValueChange={(value) =>
                                    setFilterState((p) => ({
                                        ...p,
                                        sub_company_id:
                                ...
                                <tbody>
                                    ...
                                    {requests.data.map((row) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-3 py-3">
                                                {row.fulfilled_headcount}/
                                                {row.requested_headcount}
                                            </td>
                                            <td className="px-3 py-3">
                                                {row.needed_by ?? '-'}
                                            </td>
            ...
            >
                <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-4xl">
                    <DialogHeader>
                        <DialogTitle>
                            {editing
                                ? `Edit ${editing.request_number}`
                                : 'Tambah Manpower Request'}
                        </DialogTitle>
                        <DialogDescription>
                            Catat kebutuhan tenaga kerja dari klien/sub-company.
                        </DialogDescription>
                    </DialogHeader>
                    {requestForm}
                </DialogContent>
