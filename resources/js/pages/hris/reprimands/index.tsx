                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Catat teguran lisan dan surat peringatan karyawan.
                        </p>
                    </div>
                ...
                <Card>
                    <CardHeader className="p-0">
                        <button
                            ...
                            className="flex w-full items-center justify-between gap-4 px-5 py-2.5 text-left hover:bg-muted/40"
                        >
                            <div>
                                ...
                                <CardDescription className="mt-0.5 text-xs">
                                    Saring data berdasarkan karyawan, level, dan
                                    status.
                                </CardDescription>
                            </div>
                            <ChevronDown
                                className={`size-5 shrink-0 text-muted-foreground transition-transform ${filterOpen ? 'rotate-180' : ''}`}
                            />
                        </button>
                    </CardHeader>
                    {filterOpen && (
                        <CardContent className="border-t py-3">
                            <form
                                ...
                                className="grid gap-3 lg:grid-cols-[minmax(220px,1fr)_160px_160px_auto]"
                            >
                                <SearchableSelect
                                    ...
                                    {reprimands.data.map((row) => (
                                        ...
                                        >
                                            <td className="px-3 py-3 font-medium">
                                                {row.reprimand_number}
                                            </td>
                                            <td className="px-3 py-3">
                                                <Link
                                                    className="text-primary hover:underline"
                                                    href={`/hris/reprimands/tracking/${row.employee_id}`}
                                                >
                                                    {row.employee_label}
                                                </Link>
                                            </td>
            ...
            >
                <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-3xl">
                    <DialogHeader>
                        <DialogTitle>
                            {editing
                                ? `Edit ${editing.reprimand_number}`
                                : 'Tambah Teguran'}
                        </DialogTitle>
                        <DialogDescription>
                            Gunakan untuk teguran lisan, SP1, SP2, atau SP3.
                        </DialogDescription>
                    </DialogHeader>
                        ...
                        <div className="space-y-6">
                            <section className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Identitas karyawan dan jenis peringatan.
                                    </p>
                                </div>
                                <div className="grid gap-4 md:grid-cols-12">
                                    ...
                                    <Field
                                        ...
                                        error={form.errors.validity_months}
                                        className="md:col-span-4"
                                    >
                                        <Input
                                            type="number"
                            ...
                            <section className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Jelaskan kejadian dan rencana perbaikan
                                        secara ringkas.
                                    </p>
                                </div>
                                <div className="grid gap-4 md:grid-cols-2">
                                    ...
                                    <TextAreaField
                                        ...
                                        error={form.errors.action_plan}
                                        onChange={(value) =>
                                            form.setData('action_plan', value)
                                        }
                                    />
                                    {editing && (
                                        <Field
                            ...
                            <section className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Upload bukti teguran atau dokumen
                                        terkait.
                                    </p>
                                </div>
                                <AttachmentDropzone
...
function Stat({
    ...
    const styles = {
        blue: {
            card: 'border-blue-200/80 bg-blue-50/70 dark:border-blue-950 dark:bg-blue-950/25',
            icon: 'bg-blue-600 text-white',
            value: 'text-blue-700 dark:text-blue-300',
        },
        emerald: {
            card: 'border-emerald-200/80 bg-emerald-50/70 dark:border-emerald-950 dark:bg-emerald-950/25',
            icon: 'bg-emerald-600 text-white',
            value: 'text-emerald-700 dark:text-emerald-300',
        },
        rose: {
            card: 'border-rose-200/80 bg-rose-50/70 dark:border-rose-950 dark:bg-rose-950/25',
        ...
        <Card className={`min-h-16 ${styles.card}`}>
            <CardContent className="flex items-center justify-between gap-4 px-4 py-2.5">
                <div className="flex items-center gap-3">
                    <span
                        className={`grid size-8 place-items-center rounded-full ${styles.icon}`}
                    >
                ...
                <CardTitle className={`text-2xl leading-none ${styles.value}`}>
                    {value}
                </CardTitle>
            </CardContent>
        </Card>
    ...
    return (
        <div className="grid gap-2">
            <div
                ...
                tabIndex={0}
                onClick={() =>
                    document.getElementById('reprimand-attachment')?.click()
                }
                onKeyDown={(event) => {
                    if (event.key === 'Enter' || event.key === ' ')
                        document
                            .getElementById('reprimand-attachment')
                            ?.click();
                }}
                onDragOver={(event) => {
                    event.preventDefault();
