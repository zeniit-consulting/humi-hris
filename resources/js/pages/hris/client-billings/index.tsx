...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Billing Klien', href: pageUrl },
];
...
export default function ClientBillingPage() {
    const { invoices, subCompanies, filters, statusOptions, stats } =
            ...
            <div className="space-y-4 p-4">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Pilih periode, klien, dan status invoice yang ingin
                            ditampilkan.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form
                            ...
                            className="grid gap-3 lg:grid-cols-[180px_minmax(240px,1fr)_180px_auto]"
                        >
                            ...
                            <div className="grid gap-2">
                                ...
                                <Select
                                    value={
                                        filterState.sub_company_id || '__all'
                                    }
                                    onValueChange={(value) =>
                                        setFilterState((p) => ({
                                            ...p,
            ...
            >
                <DialogContent className="max-w-3xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Sistem mengambil nilai payroll reguler per
                            sub-company. Jika payroll belum digenerate, sistem
                            memakai gaji pokok aktif.
                        </DialogDescription>
                    </DialogHeader>
                    <form
                    ...
                    >
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                onChange={(event) =>
                                    form.setData('period', event.target.value)
                                }
                            />
