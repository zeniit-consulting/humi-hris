...
type PageProps = {
    ...
    reimbursementRequests: RequestRow[];
};

const pageUrl = '/client/approvals';
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Approval Klien', href: pageUrl },
];
...
const approveUrls = {
    ...
    reimbursements: (id: number) => `${pageUrl}/reimbursements/${id}/approve`,
};
const rejectUrls = {
    ...
    reimbursements: (id: number) => `${pageUrl}/reimbursements/${id}/reject`,
};
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {rejectTarget?.row.employee_label}
                        </DialogDescription>
                    </DialogHeader>
