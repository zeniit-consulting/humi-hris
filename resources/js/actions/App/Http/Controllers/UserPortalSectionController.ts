...
* @see app/Http/Controllers/UserPortalSectionController.php:112
...
const UserPortalSectionController = { attendance, checkIn, checkOut, shiftChange, attendanceRequest, leaves, overtimes, kasbons, payroll, profile, announcements, surveys, assets, previewPayslip, exportPayslip }
