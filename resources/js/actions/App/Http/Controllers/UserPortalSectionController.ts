...
* @see app/Http/Controllers/UserPortalSectionController.php:117
...
const UserPortalSectionController = { attendance, checkIn, checkOut, shiftChange, attendanceRequest, leaves, overtimes, kasbons, payroll, activity, profile, announcements, surveys, assets, previewPayslip, exportPayslip }
