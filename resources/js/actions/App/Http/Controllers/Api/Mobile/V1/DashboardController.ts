...
/**
* @see \App\Http\Controllers\Api\Mobile\V1\DashboardController::summary
* @see app/Http/Controllers/Api/Mobile/V1/DashboardController.php:19
* @route '/api/mobile/v1/dashboard/summary'
*/
...
summary.definition = {
    methods: ["get","head"],
    url: '/api/mobile/v1/dashboard/summary',
...
const DashboardController = { summary }
