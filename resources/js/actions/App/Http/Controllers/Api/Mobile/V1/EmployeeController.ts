...
/**
* @see \App\Http\Controllers\Api\Mobile\V1\EmployeeController::index
* @see app/Http/Controllers/Api/Mobile/V1/EmployeeController.php:16
* @route '/api/mobile/v1/employees'
*/
...
/**
* @see \App\Http\Controllers\Api\Mobile\V1\EmployeeController::show
* @see app/Http/Controllers/Api/Mobile/V1/EmployeeController.php:74
* @route '/api/mobile/v1/employees/{employee}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/api/mobile/v1/employees/{employee}',
} satisfies RouteDefinition<["get","head"]>
