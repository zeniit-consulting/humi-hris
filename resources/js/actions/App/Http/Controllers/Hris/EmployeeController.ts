...
const EmployeeController = { index, downloadImportTemplate, importMethod, exportMethod, contract, activatePortalUser, offboard, store, update, destroy, import: importMethod, export: exportMethod }
