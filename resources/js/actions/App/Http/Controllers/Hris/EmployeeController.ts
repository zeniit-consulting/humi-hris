...
* @see app/Http/Controllers/Hris/EmployeeController.php:516
...
* @see app/Http/Controllers/Hris/EmployeeController.php:571
...
* @see app/Http/Controllers/Hris/EmployeeController.php:441
...
* @see app/Http/Controllers/Hris/EmployeeController.php:775
...
* @see app/Http/Controllers/Hris/EmployeeController.php:900
...
* @see app/Http/Controllers/Hris/EmployeeController.php:826
* @route '/hris/employees'
*/
...
* @see app/Http/Controllers/Hris/EmployeeController.php:873
...
* @see app/Http/Controllers/Hris/EmployeeController.php:924
* @route '/hris/employees/{employee}'
*/
...
const EmployeeController = { index, downloadImportTemplate, importMethod, exportMethod, contract, activatePortalUser, store, update, destroy, import: importMethod, export: exportMethod }
