...
* @see app/Http/Controllers/Hris/AttendanceController.php:290
...
* @see app/Http/Controllers/Hris/AttendanceController.php:223
...
* @see app/Http/Controllers/Hris/AttendanceController.php:234
* @route '/hris/attendances'
*/
...
* @see app/Http/Controllers/Hris/AttendanceController.php:264
...
* @see app/Http/Controllers/Hris/AttendanceController.php:280
* @route '/hris/attendances/{employeeAttendance}'
*/
...
const AttendanceController = { index, exportMethod, showMonthly, syncMissingCheckouts, store, update, destroy, export: exportMethod }
