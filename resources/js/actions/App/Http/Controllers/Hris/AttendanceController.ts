...
* @see app/Http/Controllers/Hris/AttendanceController.php:294
...
* @see app/Http/Controllers/Hris/AttendanceController.php:266
...
* @see app/Http/Controllers/Hris/AttendanceController.php:284
* @route '/hris/attendances/{employeeAttendance}'
*/
