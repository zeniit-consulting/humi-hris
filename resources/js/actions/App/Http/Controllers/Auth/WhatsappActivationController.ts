...
/**
* @see \App\Http\Controllers\Auth\WhatsappActivationController::show
...
const WhatsappActivationController = { show, send, verify }

export default WhatsappActivationController