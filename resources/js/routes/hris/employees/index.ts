...
* @see app/Http/Controllers/Hris/EmployeeController.php:46
...
* @see app/Http/Controllers/Hris/EmployeeController.php:549
...
* @see app/Http/Controllers/Hris/EmployeeController.php:745
...
* @see app/Http/Controllers/Hris/EmployeeController.php:803
...
* @see app/Http/Controllers/Hris/EmployeeController.php:557
...
* @see app/Http/Controllers/Hris/EmployeeController.php:1013
...
* @see app/Http/Controllers/Hris/EmployeeController.php:1230
...
/**
* @see \App\Http\Controllers\Hris\EmployeeController::inviteUser
* @see app/Http/Controllers/Hris/EmployeeController.php:1238
* @route '/hris/employees/{employee}/invite-user'
*/
export const inviteUser = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: inviteUser.url(args, options),
    method: 'post',
})
...
* @route '/hris/employees/{employee}/invite-user'
*/
inviteUser.url = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { employee: args }
    }
    ...
    return inviteUser.definition.url
            .replace('{employee}', parsedArgs.employee.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/hris/employees/{employee}/invite-user'
*/
inviteUser.post = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: inviteUser.url(args, options),
    method: 'post',
})
...
* @route '/hris/employees/{employee}/invite-user'
*/
const inviteUserForm = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: inviteUser.url(args, options),
    method: 'post',
})
...
* @route '/hris/employees/{employee}/invite-user'
*/
inviteUserForm.post = (args: { employee: number | { id: number } } | [employee: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: inviteUser.url(args, options),
    method: 'post',
})
...
* @see app/Http/Controllers/Hris/EmployeeController.php:1192
...
* @see app/Http/Controllers/Hris/EmployeeController.php:1290
...
* @see app/Http/Controllers/Hris/EmployeeController.php:1065
* @route '/hris/employees'
*/
...
* @see app/Http/Controllers/Hris/EmployeeController.php:1118
...
* @see app/Http/Controllers/Hris/EmployeeController.php:1365
* @route '/hris/employees/{employee}'
*/
...
const employees = {
    ...
    resigned: Object.assign(resigned, resigned),
    ...
    inviteUser: Object.assign(inviteUser, inviteUser),
    activatePkwtt: Object.assign(activatePkwtt, activatePkwtt),
