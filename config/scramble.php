...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Read-only HRIS integration API for approved third-party systems.',
    ],

    'ui' => [
        'title' => 'ZENI HRIS Third-Party API',
    ],
    ...
    'docs_public' => env('SCRAMBLE_DOCS_PUBLIC', false),
