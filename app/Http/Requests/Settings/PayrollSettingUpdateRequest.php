...
class PayrollSettingUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'overtime_events.*.code' => ['nullable', 'string', 'max:50'],
            'overtime_events.*.nominal' => ['required', 'numeric', 'min:0'],
            'overtime_events.*.unit' => ['nullable', 'in:kegiatan,hari,jam,kehadiran'],
            'overtime_events.*.position_ids' => ['nullable', 'array'],
            'overtime_events.*.position_ids.*' => ['integer'],
